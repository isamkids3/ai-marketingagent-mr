...
> [!NOTE]
> Empty default placeholder subdirectories have been omitted from the tree above for brevity. Please also ignore any extra or experimental model files fetched during testing — only the relevant model weights for active generation workflows are required.
